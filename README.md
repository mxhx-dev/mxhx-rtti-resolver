...
Using a document tree generated by [mxhx-xml-parser](https://github.com/mxhx-dev/mxhx-xml-parser), and [Runtime Type Information (RTTI)](https://haxe.org/manual/cr-rtti.html), resolves the symbols that the XML tags, attributes, and text represent.
